...
def create_widgets():
    ...
    # Create a VBox container with all the widgets
    widget_box = widgets.VBox([start, end, lon1, lon2, lat1, lat2])

    # Return individual widgets and the VBox container
    return widget_start_date, widget_start_time, widget_end_date, widget_end_time, lon1, lon2, lat1, lat2, widget_box
